...
<strong>These equations can be constrained by measuring the macroscopic properties of NSs </strong> (e.g., mass and radius) and that's why NSs provide a unique place to study the equation of state of ultra-dense matter. One promising method to measure neutron star radii consists of the study of low-mass X-ray binaries in quiescence (qLMXB), in which the X-ray emission comes primarily from the star and not so much from the disk, so we can characterize its surface emission!
